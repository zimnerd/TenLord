...
<div class="form-group col-md-6">
    <?php echo Form::label('number_of_units', 'Number of Units:'); ?>

    <?php echo Form::text('number_of_units'); ?>

</div>

<div class="form-group col-md-6">
    <?php echo Form::label('owner_id', 'Select Owner:'); ?>

    <?php echo Form::text('owner_id'); ?>
