<nav class="navbar navbar-default navbar-static-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                <?php echo e(config('app.name', 'Eddy')); ?>
    ...
    <img src="/images/<?php echo e(Auth::user()->avatar); ?>" style="width:32px; height:32px; position:absolute; top:10px; left:10px; border-radius:50%">
        ...
        <div class="modal-content">
            <div class="panel panel-filled">
                <div class="panel-body">
                    <form action="<?php echo e(url('/login')); ?>" method="POST" id="loginForm" novalidate>
...
<div class="modal fade" id="registerModal" tabindex="-1" role="dialog" hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="panel panel-filled">
                <div class="panel-body">
                    <form action="<?php echo e(url('/register')); ?>" method="POST" id="registerForm">
...
<div class="modal fade" id="resetModal" tabindex="-1" role="dialog" hidden="true">
    <div class="login-dialog">
        <div class="modal-content">
            <div class="panel panel-filled">
                <div class="panel-body">
                    <form action="<?php echo e(url('/password/email')); ?>" method="POST" id="resetForm" novalidate>
