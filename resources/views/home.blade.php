@extends('layouts.app')
@section('title', 'Welcome to TenLord Dashboard')
...
<div class="row">
    <div class="col-sm-4">
        <div class="tile purple">
            <h3 class="title"><span class="glyphicon glyphicon-home"></span> <a href="{{ url('/properties') }}">Properties</a></h3>
            <p>{{ $property->count() }} properties listed </p>
            <p>{{ $unit->count() }} total units</p>
...
@else
    ...
    <div class="btn-group-lg">
        ...
        <a href="{{ url('/register') }}" class="btn btn-success">Register</a></div>
@endif
